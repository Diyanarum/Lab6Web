...
Sebelumnya, untuk dapat membuat sebuah halaman web seperti di atas, kalian dapat melihatnya pada repository saya di github sebelumnya dengan judul Lab5JavaScript seperti dibawah ini.
...
<body>
    <div class="container-md shadow-lg p-3 mb-5 bg-body rounded">
        ...
        <nav class="navbar navbar-light" style="background-color: #8e3d5f;">
            <ul class="nav">
                <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#" style="background-color: rgb(196, 150, 170); color: rgb(0, 0, 0);">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" style="color: rgb(255, 255, 255);" >Artikel</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" style="color: rgb(255, 255, 255);">About</a>
                </li>
                <li class="nav-item">
                    <a href="#" class="nav-link" style="color: rgb(255, 255, 255);">Kontak</a>
                </li>
            </ul>
        </nav>
        ...
        <div class="card-footer" style="background-color: rgb(119, 54, 81);">
